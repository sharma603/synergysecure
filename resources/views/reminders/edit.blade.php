        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="card-title mb-0">Edit Reminder</h4>
                ...
                <form action="{{ route('reminders.update', $reminder->id) }}" method="POST">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" id="title" name="title" 
                                    value="{{ old('title', $reminder->title) }}" placeholder="Enter reminder title" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea class="form-control" id="description" name="description" 
                            rows="4" placeholder="Enter reminder details">{{ old('description', $reminder->description) }}</textarea>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="reminder_email" name="reminder_email" 
                                        value="{{ old('reminder_email', $reminder->reminder_email) }}" 
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="company_id" name="company_id">
                                    ...
                                    @foreach($companies as $company)
                                        <option value="{{ $company->id }}" {{ old('company_id', $reminder->company_id) == $company->id ? 'selected' : '' }}>
                                            {{ $company->name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group form-check mt-4 border-top pt-3">
                        <input type="checkbox" class="form-check-input" id="is_completed" 
                            name="is_completed" value="1" {{ old('is_completed', $reminder->is_completed) ? 'checked' : '' }}>
